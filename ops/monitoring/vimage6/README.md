...
- Grafana dashboard **Tahti vital services** (`uid: tahti-vital-services`)
...
| `GET /metrics` | Prometheus gauges: `tahti_dependency_up`, `tahti_api_healthy`, latencies |
...
Open Grafana on vimage6 → **Dashboards** → **Tahti vital services**. Datasource UID `P501B54A0D5548634` must match the local Prometheus datasource.
