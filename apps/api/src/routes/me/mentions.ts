...
const mentionRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.patch(
    '/api/me/mentions/settings',
    {
      ...
      schema: {
        tags: ['channel'],
        response: openApiResponse(MentionsEnabledResponseSchema, 'MentionsEnabled'),
      },
    },
    async (request, reply) => {
    ...
    '/api/me/mentions/mute/:handle',
    {
      ...
      schema: {
        ...
        response: openApiResponses([
          { status: 201, schema: MuteHandleResponseSchema, name: 'MuteHandle' },
        ]),
      },
    },
    async (request, reply) => {
  ...
  fastify.delete(
    '/api/me/mentions/mute/:handle',
    {
      ...
      schema: {
        tags: ['channel'],
        response: openApiResponse(MuteHandleResponseSchema, 'MuteHandle'),
      },
    },
    async (request, reply) => {
      const user = request.sessionUser!
