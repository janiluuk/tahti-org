...
// Board access to any artist's sound/track metadata — mirrors /api/me/sound's
...
const adminSoundRoutes: FastifyPluginAsync = async (fastify) => {
  fastify.get(
...
export default adminSoundRoutes
