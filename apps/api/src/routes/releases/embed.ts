...
const embedRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.get(
    '/oembed',
    {
      schema: {
        ...
        response: openApiResponse(OEmbedResponseSchema, 'OEmbed'),
      },
    },
    async (request, reply) => {
  ...
  fastify.get(
    '/api/v1/embed/r/:id',
    {
      schema: {
        tags: ['releases'],
        response: openApiResponse(ReleaseEmbedViewSchema, 'ReleaseEmbed'),
      },
    },
    async (request, reply) => {
  ...
  fastify.get(
    '/api/v1/embed/c/:slug',
    {
      schema: {
        tags: ['releases'],
        response: openApiResponse(ChannelEmbedViewSchema, 'ChannelEmbed'),
      },
    },
    async (request, reply) => {
