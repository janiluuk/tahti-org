    ...
    openapi: {
      ...
      components: {
        ...
        schemas: zodOpenApiComponents({
          ...
          VenueRecord: VenueRecordSchema,
          VenueBroadcastRecord: VenueBroadcastRecordSchema,
          AdminVenueList: AdminVenueListSchema,
          MixcloudConnectionStatus: MixcloudConnectionStatusSchema,
          MixcloudDisconnect: MixcloudDisconnectSchema,
          MixcloudQueueResponse: MixcloudQueueResponseSchema,
          MixcloudUploadStatus: MixcloudUploadStatusSchema,
          InternalWebhookOk: InternalWebhookOkSchema,
          ...
          FanTier: FanTierViewSchema,
          FanTierList: FanTierListSchema,
          ReleaseTrack: ReleaseTrackViewSchema,
          ReleaseTrackUploadPrepare: ReleaseTrackUploadPrepareSchema,
          ReleaseTrackFinalize: ReleaseTrackFinalizeSchema,
          MeTrackDownload: MeTrackDownloadSchema,
          ChatPublishResult: ChatPublishResultSchema,
          ChatAccess: ChatAccessResponseSchema,
          ChatFanToken: ChatFanTokenResponseSchema,
          ChatAnnouncement: ChatAnnouncementViewSchema,
          MentionsEnabled: MentionsEnabledResponseSchema,
          MuteHandle: MuteHandleResponseSchema,
          ArchiveVersionList: ArchiveVersionListSchema,
          ArchiveVersionPrepare: ArchiveVersionPrepareResponseSchema,
          ArchiveVersionCreated: ArchiveVersionCreatedSchema,
          ReleaseArtworkPrepare: ReleaseArtworkPrepareResponseSchema,
          ReleaseArtworkComplete: ReleaseArtworkCompleteResponseSchema,
          CollectionList: CollectionListSchema,
          Collection: CollectionViewSchema,
          CollectionItem: CollectionItemViewSchema,
          CollectionReorder: CollectionReorderResponseSchema,
          UserSearchList: UserSearchListSchema,
          RevelatorStatus: RevelatorStatusResponseSchema,
          RevelatorSubmit: RevelatorSubmitResponseSchema,
          NewsletterSendQueued: NewsletterSendQueuedSchema,
          GrantRun: GrantRunResponseSchema,
          ChannelGallery: ChannelGalleryViewSchema,
          ChannelSlideshow: ChannelSlideshowViewSchema,
          ChannelTextLayer: ChannelTextLayerViewSchema,
          ReleaseTrackVersionList: ReleaseTrackVersionListSchema,
        }),
      },
      tags: [
