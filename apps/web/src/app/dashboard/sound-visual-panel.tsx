...
import { updateSoundItemVisual } from './channel-visual-actions'
...
export default function SoundVisualPanel({ itemId, initial }: Props) {
  ...
  function save() {
    ...
    startTransition(async () => {
      const res = await updateSoundItemVisual(itemId, {
        visualPreset: preset,
