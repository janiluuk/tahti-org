    ...
    <div className="stream-settings">
      <div className="stream-settings__collapse-row">
        ...
        <Button
          ...
          aria-expanded="true"
          aria-label="Collapse broadcasting software connection"
        >
          Collapse
        </Button>
      </div>
              ...
              <CopyRow
                ...
                action={
                  <Button
                    ...
                    aria-label="Rotate RTMP key"
                    title="Rotate RTMP key"
                    className="stream-settings__rotate"
                  >
                    ↻
                  </Button>
                }
              ...
              <CopyRow
                ...
                action={
                  <Button
                    ...
                    aria-label="Rotate Icecast password"
                    title="Rotate Icecast password"
                    className="stream-settings__rotate"
                  >
                    ↻
                  </Button>
