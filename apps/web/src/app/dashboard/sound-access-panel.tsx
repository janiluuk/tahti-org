...
import type { SoundAccessPatch } from '@tahti/shared'
import { ButtonIcon, Panel, Button } from '@tahti/ui'
import { fetchMyPurchaseTiers, updateSoundAccess } from './channel-visual-actions'

type AccessMode = SoundAccessPatch['accessMode']
...
export default function SoundAccessPanel({
  itemId,
  initial,
}: {
  itemId: string
  ...
  function save() {
    ...
    startTransition(async () => {
      const res = await updateSoundAccess(itemId, {
