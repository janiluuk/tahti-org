...
const INTEGRATION_VENDORS = [
  ...
  {
    name: 'Bandcamp',
    service: 'Import own releases (FLAC masters) into the archive',
    envVars: 'BANDCAMP_CLIENT_ID, BANDCAMP_CLIENT_SECRET',
    portalUrl: 'https://bandcamp.com/developer',
    dpaRequired: true,
    dpaNote: 'Review terms for artist data subprocessor obligations',
  },
  {
    ...
    envVars: 'SOUNDCLOUD_CLIENT_ID, SOUNDCLOUD_CLIENT_SECRET',
    portalUrl: 'https://developers.soundcloud.com/',
    dpaRequired: true,
    dpaNote: 'Review terms for artist data subprocessor obligations',
  },
  {
    name: 'Google Drive',
    service: 'Cloud-storage import (Picker API) into the archive',
    envVars: 'GOOGLE_DRIVE_CLIENT_ID, GOOGLE_DRIVE_CLIENT_SECRET, GOOGLE_DRIVE_DEVELOPER_KEY',
  ...
  },
  {
    ...
    portalUrl: 'https://developer.twitter.com/',
    dpaRequired: false,
    dpaNote: null,
  },
  {
