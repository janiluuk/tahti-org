...
export default async function GreenRoomPage({ params }: { params: { username: string } }) {
  const profile = await fetchProfile(params.username)
  if (!profile?.channel?.slug) notFound()

  return (
    <ProfilePageLayout>
      <div className="green-room-page">
        <h1 className="green-room-page__title">{profile.displayName}&apos;s green room</h1>
