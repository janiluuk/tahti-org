...
export default function AddonsHelpPage() {
  return (
    <article className="brand-prose">
      ...
      <Heading level={1}>Contribute an Addon</Heading>
      <Text>
        Addons are small, sandboxed add-ons that show up in the store on a listener&apos;s Discover
        page, an artist&apos;s channel page, or the Tahti homepage. Anyone can build one and submit
        it — publishing into a live store is still done by a Tahti admin, but getting your code in
        front of one is as simple as opening a pull request.
      </Text>
      ...
      <ol>
        <li>
          ...
          <code>contrib/addons/&lt;your-widget-slug&gt;/</code> — include your source (
      ...
      <Text>
        ...
        widget, publishes it through the Addons admin panel, and approves it — at that point
