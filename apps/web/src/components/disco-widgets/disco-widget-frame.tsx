...
} from '@tahti/widget-sdk'

export interface DiscoWidgetFrameProps {
 ...
 * /widget-sandbox/[bundleHash]) and speaks the @tahti/widget-sdk postMessage
 * protocol to it. This is the ONLY place widget code ever runs — never in the
 * main page's own JS realm. */
export function DiscoWidgetFrame({ sandboxUrl, name, context, config }: DiscoWidgetFrameProps) {
