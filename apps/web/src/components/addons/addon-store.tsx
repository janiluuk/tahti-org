...
import type { AddonStoreItem } from '@tahti/shared'

const CATEGORY_ALL = 'all'

export interface AddonStoreProps {
  widgets: AddonStoreItem[]
  ...
  return (
    <div>
      ...
      <p className="studio-text-muted-sm studio-mt-sm">
        ...
        <Link href="/help/addons">learn how to submit your own</Link>.
      </p>
