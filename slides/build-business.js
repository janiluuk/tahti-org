...
async function main() {
  ...
  // ─── Slide 2: the mission ────────────────────────────────────────
  {
    ...
    s.addText(
      [
        {
          text: 'Tahti ry advances the work of independent musicians and DJs by ',
          options: { color: COL.textLight },
        },
        {
          text: 'providing them with a free, open-source broadcasting tool',
          options: { color: COL.cyan, bold: true },
        },
        {
          text: ' that enables a 24/7 channel, distribution to music services, and ',
          options: { color: COL.textLight },
        },
  ...
  // ─── Slide 3: what the product is ───────────────────────────────
  {
    ...
    s.addText(
      'One URL per artist. Always playing. Live when they\u2019re on, archive when they\u2019re not.',
      {
        x: 0.7,
        y: 1.15,
        w: 12,
    ...
    const steps = [
      {
        icon: FaMicrophone,
        color: COL.cyan,
        title: 'Artist broadcasts',
        body: 'OBS, Mixxx, Traktor, butt, or browser-based Go Live',
      },
      {
        icon: FaBroadcastTower,
        color: COL.violet,
        title: 'Channel goes live',
        body: 'Liquidsoap distributes via HLS + optional RTMP multistream',
      },
      {
        icon: FaCommentDots,
        color: COL.mint,
        title: 'Listeners + chat',
        body: 'Anonymous tune-in, ephemeral chat with pinned announcements',
      },
      {
        icon: FaCompactDisc,
        color: COL.amber,
        title: 'Auto-archived',
        body: 'Recording saved, ready for distribution and fallback rotation',
      },
    ]
    ...
    s.addText(
      [
        {
          text: 'Each channel runs as one perpetual Liquidsoap process. When the artist stops broadcasting, ',
        ...
        {
          text: 'operator instantly switches to the archive playlist with ',
          options: { color: COL.textMuted },
        },
        { text: 'no audio gap. ', options: { color: COL.textLight, bold: true } },
        {
          text: 'The same URL that played a live set yesterday plays the recorded mixes today. This is the entire product compressed into one technical detail.',
          options: { color: COL.textMuted },
        },
      ],
  ...
  // ─── Slide 4: chat and OBS as featured ──────────────────────────
  {
    ...
    const features = [
      ...
      },
      {
        ...
        color: COL.cyan,
        icon: FaBroadcastTower,
        head: 'OBS + broadcasting',
        sub: 'Guides for every tool',
        rows: [
      ...
      },
      {
        ...
        head: 'Promo toolkit',
        sub: 'Spread the word, measure it',
        rows: [
      ...
      },
      {
        ...
        color: COL.rose,
        icon: FaHandHoldingHeart,
        head: 'Fan-subscriptions',
        sub: 'Direct support \u2014 0% org take',
        rows: [
      ...
      },
      {
        ...
        icon: FaBroadcastTower,
        head: 'Tahti Radio',
        sub: '24/7 live-relay meta-stream',
        rows: [
  ...
  // ─── Slide 5: pricing tiers ─────────────────────────────────────
  {
    ...
    s.addText(
      'Listeners never pay. Paying artists become members of the association \u2014 eligible for annual grants.',
      {
        x: 0.7,
        y: 1.15,
        w: 12,
  ...
  // ─── Slide 6: storage policy ────────────────────────────────────
  {
    ...
    s.addText(
      'Hard limits are a tax on serious artists. We display usage, we nudge, we don\u2019t cut anyone off.',
      {
        x: 0.7,
        y: 1.1,
        w: 12,
    ...
    s.addShape(pres.shapes.RECTANGLE, {
      ...
      w: 0.08,
      h: 1.4,
      fill: { color: COL.violet },
      line: { color: COL.violet },
    })
    ...
    s.addText(
      [
        {
          text: '\u201CTahti ry does not impose enforced storage limits on member channels. The Board may revisit this policy if aggregate storage cost exceeds 25% of subscription revenue, by proposing an amendment subject to member vote at the next General Meeting.\u201D',
  ...
  // ─── Slide 7: revenue mix ───────────────────────────────────────
  {
    ...
    s.addChart(pres.charts.BAR, data, {
      ...
      chartArea: { fill: { color: COL.bg } },
      plotArea: { fill: { color: COL.bg } },
      catAxisLabelColor: COL.textMuted,
      catAxisLabelFontSize: 12,
      valAxisLabelColor: COL.textMuted,
      valAxisLabelFontSize: 11,
      valGridLine: { color: COL.cardBorder, size: 0.5 },
      catGridLine: { style: 'none' },
      showLegend: true,
      legendPos: 'b',
      legendColor: COL.textLight,
      legendFontSize: 10,
      showTitle: false,
    })
  ...
  // ─── Slide 8: where the money goes ──────────────────────────────
  {
    ...
    s.addText(
      'Year 3 illustrative breakdown. 90% of surplus returns to artists; 10% builds operating reserve.',
      {
        x: 0.7,
        y: 1.15,
        w: 12,
    ...
    s.addChart(
      ...
      ],
      {
        ...
        showLegend: false,
        showValue: true,
        dataLabelColor: COL.textLight,
        dataLabelFontSize: 10,
        dataLabelPosition: 'outEnd',
        showTitle: true,
        title: 'Year 3 outflows (\u20AC)',
        titleColor: COL.textLight,
        titleFontSize: 14,
      },
    )
  ...
  // ─── Slide 9: 3-year summary ────────────────────────────────────
  {
    ...
    s.addTable(
      [
        ...
        [
          ...
          {
            text: '\u20AC434,142',
            options: { color: COL.cyan, fontSize: 13, bold: true, align: 'right' },
          },
        ],
        [
          ...
          {
            text: '\u20AC286,984',
            options: { color: COL.rose, fontSize: 13, bold: true, align: 'right' },
          },
        ],
        [
          ...
          {
            text: '-\u20AC19,146',
            options: { color: COL.rose, fontSize: 12, bold: true, align: 'right' },
          },
          {
            text: '+\u20AC22,152',
            options: { color: COL.mint, fontSize: 12, bold: true, align: 'right' },
          },
          {
            text: '+\u20AC144,152',
            options: { color: COL.mint, fontSize: 12, bold: true, align: 'right' },
          ...
          {
            text: '+\u20AC147,158',
            options: { color: COL.mint, fontSize: 13, bold: true, align: 'right' },
          },
        ],
        [
          ...
          {
            text: '\u20AC115,000',
            options: { color: COL.amber, fontSize: 13, bold: true, align: 'right' },
          },
        ],
        [
          {
            text: 'Artist grants distributed',
            options: { color: COL.textLight, fontSize: 12, bold: true },
          },
          {
            text: '\u20AC0',
            options: { color: COL.mint, fontSize: 12, bold: true, align: 'right' },
        ...
        [
          {
            text: 'Fan-sub direct to artists',
            options: { color: COL.textLight, fontSize: 12, bold: true },
          },
          {
            text: '\u20AC1,622',
            options: { color: COL.violet, fontSize: 12, bold: true, align: 'right' },
          },
          {
            text: '\u20AC22,705',
            options: { color: COL.violet, fontSize: 12, bold: true, align: 'right' },
          ...
          {
            text: '\u20AC162,721',
            options: { color: COL.violet, fontSize: 13, bold: true, align: 'right' },
          },
        ],
        [
          {
            text: 'Total artist money',
            options: { color: COL.textLight, fontSize: 12, bold: true },
          },
          {
            text: '\u20AC1,622',
            options: { color: COL.amber, fontSize: 12, bold: true, align: 'right' },
          },
          {
            text: '\u20AC42,642',
            options: { color: COL.amber, fontSize: 12, bold: true, align: 'right' },
          ...
          {
            text: '\u20AC312,395',
            options: { color: COL.amber, fontSize: 14, bold: true, align: 'right' },
          },
        ],
      ],
      {
    ...
    s.addText(
      [
        ...
        {
          text: '\u20AC312k in artists\u2019 hands over 3 years \u2014 grants + direct fan-subs \u2014 while paying the director a fair Finnish wage.',
          options: { color: COL.textLight, italic: true },
        },
      ],
      {
        x: 0.95,
  ...
  // ─── Slide 10: governance & transparency ────────────────────────
  {
    ...
    s.addText(
      'Finnish yhdistys, AGPL software, public ledger. The structure makes promises keepable.',
      {
        x: 0.7,
        y: 1.1,
        w: 12,
  ...
  // ─── Slide 11: funding strategy ─────────────────────────────────
  {
    ...
    s.addText(
      'The Y1 grant gap is the existential question. Securing one of these is the first milestone.',
      {
        x: 0.7,
        y: 1.15,
        w: 12,
    ...
    for (let i = 0; i < sources.length; i++) {
      ...
      s.addShape(pres.shapes.RECTANGLE, {
        ...
        w,
        h: 0.4,
        fill: { color: src.color, transparency: 20 },
    ...
    s.addText(
      [
        ...
        {
          text: 'secure \u20AC25,000 from any single source (or split across two). Apply to Tempo + Koneen + Kulttuurirahasto in parallel.',
          options: { color: COL.textMuted, italic: true },
        },
      ],
      {
  ...
  // ─── Slide 12: the ask / next steps ────────────────────────────
  {
    ...
    s.addText(
      'From founding meeting to first beta, with the grant deadlines that shape the calendar.',
      {
        x: 0.7,
        y: 1.15,
        w: 12,
