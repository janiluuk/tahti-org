...
E2E_DEMO_ARCHIVE_TITLE="${E2E_DEMO_ARCHIVE_TITLE:-Live at Klubi — March 2026}"
E2E_DEMO_BOARD_EMAIL="${E2E_DEMO_BOARD_EMAIL:-screenshot-board@e2e.tahti.live}"
E2E_DEMO_BOARD_USER="${E2E_DEMO_BOARD_USER:-screenshot-board}"
E2E_FRESH_EMAIL="${E2E_FRESH_EMAIL:-screenshot-fresh@e2e.tahti.live}"
E2E_FRESH_USER="${E2E_FRESH_USER:-screenshot-fresh}"
E2E_GRANT_YEAR="${E2E_GRANT_YEAR:-2031}"
