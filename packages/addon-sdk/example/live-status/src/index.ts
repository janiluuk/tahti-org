...
// Reference Addon (ARTIST scope): shows whether the channel is live
// right now. Build with `pnpm --filter @tahti/addon-sdk run
// build:example:live-status`, then upload dist/bundle.js via the admin
// catalog flow described in ../../README.md.

import { mountAddon } from '../../../src/index.js'
import type { AddonModule } from '../../../src/index.js'
