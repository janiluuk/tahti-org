...
/** Guided open-catalog submission (M30). */
export const MUSICBRAINZ_GUIDE_STEPS = [
  'Export JSON from this panel (or copy UPC, ISRC, credits, P/C-lines).',
  ...
  'Save the release, then copy the release MBID back into this form.',
