...
export const SoundEditListDraftResponseSchema = z.object({
...
export const SoundEditListDraftPatchSchema = z
  .object({
    editList: EditListSchema,
...
export const SoundEditListDraftPatchResponseSchema = z.object({
  ok: z.literal(true),
  updatedAt: z.string().datetime(),
})

export const SoundEditListRenderSchema = z.object({
  editList: EditListSchema,
...
export const SoundVersionDownloadSchema = z.object({
  url: z.string().url(),
  contentType: z.string(),
})

export const SoundEditListRenderResponseSchema = z.object({
  ok: z.literal(true),
  versionId: z.string(),
