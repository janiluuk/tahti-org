...
| Collections and feeds         | `GET /api/v1/collections/:slug` (nulls `sound.audioUrl` + sets `gate` when the viewer is not entitled), `GET /api/v1/collections/:slug/rss.xml`, `GET /api/v1/u/:username/rss.xml`                                                                                                                                               |
