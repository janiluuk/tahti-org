...
| Item | Notes |
| ---- | ----- |
| Mobile UX audit (MOB-01–MOB-10) | Worklist: `docs/todo/responsive-usability-audit.md`. MOB-01/03/07/08 in PR #446; MOB-04/05 on `cursor/mobile-settings-logs-5cae`; MOB-02/06/09/10 still open |
