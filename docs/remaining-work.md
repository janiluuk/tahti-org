...
Agents: do not edit this file, `docs/features.md`, or `docs/todo/HISTORY.md`
until the PR is otherwise ready to merge. Stack related PRs. See
[`.cursor/rules/pr-stacking.mdc`](../.cursor/rules/pr-stacking.mdc).
...
| Member badge on public artist profiles       | Done: PR #456                                                                                                                                                                                              |
| Fallback cover for releases without artwork  | Gradient placeholder exists; no approved fallback asset                                                                                                                                                    |
| Recurrence duration unused                   | Done: `ScheduledLiveShow.endAt` + overlap from `recurrenceDurationMin` / `intervalHours`                                                                                                                   |
| Orphan public routes                         | `/status` unlinked; grants/venues 404 — PR #473                                                                                                                                                            |
