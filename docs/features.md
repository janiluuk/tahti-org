...
- **Association governance:** Member register, AGM/board meetings with chair/secretary and minutes-signature fields, a presigned meeting-minutes upload with a downloadable minutes URL, motions, resolutions, voting, a board governance audit log (finance, subscriptions, membership, decisions, meetings, radio bookings) on the shared LogViewer, and public governance documents.
