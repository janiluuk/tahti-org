...
| [~] | **PLAT-014** | OpenAPI response schemas generated from Zod (keep `/docs` in sync with routes) | + auth/me, uploads, newsletter, profile; public downloads, governance, funnel |
