...
| [~] | **PLAT-014** | OpenAPI response schemas generated from Zod (keep `/docs` in sync with routes) | + status, radio, venues, programme, stream-settings, membership, fan-subs connect/subscriptions; prior: auth, funnel, governance, downloads |
