...
| open    | [bloom-visualizer-preset.md](bloom-visualizer-preset.md)                       | New selective-bloom background visualizer preset (Three.js UnrealBloomPass), subtly or audio-reactively modulated, with knobs in the config dialog; which visualizer surface it targets is still undecided |
