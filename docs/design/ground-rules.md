...
| `/admin/logs` | Same pattern as `/admin/grants`: 50 rows/page with Previous/Next pagination, not an unbounded list. Header + filter form bottoms out at 231px, comfortably above the fold; the table itself is the part that's tall, by design. |
