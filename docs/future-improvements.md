...
| **M11 / M29**    | Live Upptime deploy; pgBackRest PITR                                             |
| **STREAM-011 B** | Live HLS multi-bitrate / lossless spike (on-demand FLAC preference done)         |
| See              | [`remaining-work.md`](./remaining-work.md) for the full collective list          |

~~M21 / M24–M30 core product~~ — shipped; polish tracked in roadmap PLAT tables.
...
| P      | Item                                                                                         | Tracks as                                                 |
| ------ | -------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| [x]    | Branch protection: all `ci.yml` jobs required on merge                                       | PLAT-002 — verified ruleset 22306827, 2026-09-05          |
...
| ~~P1~~   | ~~`user-journeys-e2e` required in branch protection~~ — included in required **All checks**                 | Verified 2026-09-05          |
