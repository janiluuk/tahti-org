# Replay ry — broadcasting tool guides
...
### Broadcasting to your Replay channel from OBS Studio
...
- **Server:** `rtmp://rtmp.replay.fm/live` *(copy)*
...
After about 5 seconds, your channel at `<your-slug>.replay.fm` will be live.
...
### Broadcasting to your Replay channel from Mixxx
...
- **Public stream:** unchecked (Replay's directory is curated, not auto-listed)
...
start streaming. Mixxx connects to Replay and your channel goes live.
...
### Broadcasting to your Replay channel from Traktor Pro
...
### Broadcasting to your Replay channel from butt
...
Go to your Replay dashboard and click **Go Live (Browser)** in the channel panel.
